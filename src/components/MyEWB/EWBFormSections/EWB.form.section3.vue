<template>
  ...
  >
    <h5 class="text-center mb-3">Ship From Details</h5>
    <div class="row">
      <form-group
      ...
      formGroups: [
        {
          ...
          value: this.initValue.fromAddr1,
          required: true,
          class: ['col-md-4'],
        },
        {
          ...
          value: this.initValue.fromAddr2,
          required: true,
          class: ['col-md-4'],
        },
        {
          ...
          type: 'text',
          placeholder: 'City',
          value: this.initValue.fromPlace,
          required: true,
          class: ['col-md-4'],
        },
        {
          ...
          value: this.initValue.fromPincode,
          required: true,
          class: ['col-md-4'],
        },
        {
          ...
          value: this.initValue.actFromStateCode,
          required: true,
          alwaysDisabled: true,
          class: ['col-md-4'],
        },
  ...
  methods: {
    ...
    next: function () {
      ...
      if (v.isValid) {
        ...
        this.$router.push({ query: { step: 'step4', validate: true } });
      }
    },
